...
namespace DSG\BeyondTheWireRCON;

use DSG\BeyondTheWireRCON\Contracts\ServerCommandRunner;
use DSG\BeyondTheWireRCON\Data\Team;
use DSG\BeyondTheWireRCON\Data\Squad;
use DSG\BeyondTheWireRCON\Data\Player;
use DSG\BeyondTheWireRCON\Data\Population;
use DSG\BeyondTheWireRCON\Data\ServerConnectionInfo;
use DSG\BeyondTheWireRCON\Runners\BeyondTheWireRconRunner;

class BeyondTheWireServer
{
     ...
     * @param $password
     * @param float $timeout
     * @throws \DSG\BeyondTheWireRCON\Exceptions\RConException
     */
    public function __construct(ServerConnectionInfo $serverConnectionInfo, ServerCommandRunner $runner = null)
    {
        ...
        if (!$runner) {
            $runner = new BeyondTheWireRconRunner($serverConnectionInfo);
        }
